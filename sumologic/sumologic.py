...
# Lookup API Calls
    ...
    def check_lookup_status(self, job_id):
        return self.get('/lookupTables/jobs/%s/status' % job_id, version='v1')
...
# Permissions
    def get_permissions(self, id):
        return self.get('/content/%s/permissions', % id, version='v2')
    
    def add_permissions(self, id, permissions):
        return self.put('/content/%s/permissions/add', % id, params=permissions, version='v2')

    def remove_permissions(self, id, permissions):
        return self.put('/content/%s/permissions/remove', % id, params=permissions, version='v2')